  ...
  _createClass(PushNotification, [
     ...
     */
      ...
      value: function clearAllNotifications() {
        var successCallback = arguments.length > 0 && arguments[0] !== undefined
          ? arguments[0]
          : function() {};
        var errorCallback = arguments.length > 1 && arguments[1] !== undefined
          ? arguments[1]
     ...
     */
      ...
      key: 'loadPushes',
      value: function loadPushes(success, error) {
      ...
      key: 'status',
      value: function status(success) {
        if (typeof(success) != "function") {
          success = function(status) {
            console.log('Push notifications are ' + status);
          };
        }
